...
This creates a new directory `sds` within your Projects folder and downloads the course code. Use `cd sds` to enter the directory. This is your "project root directory."
