...
variable "key_vault_name" {
  type        = string
  default     = "axso-np-appl-<project-name>-<environment>-kv"
  description = "The name of the Key Vault to associate with the Disk Encryption Set. Changing this forces a new resource to be created."
...
variable "private_cluster_public_fqdn_enabled" {
  type        = bool
  default     = false
  description = "(Optional) Enable or Disable the public FQDN for the private cluster. Changing this forces a new resource to be created."
...
variable "system_node_pool_name" {
  type        = string
  default     = "syspool"
  description = "(Required) A default_node_pool"
}
...
variable "is_enabled_auto_scaling" {
  type        = bool
  default     = "true"
  description = "Auto scalling is set to True or False"
}
...
#-----------------------------------------------------------------------------------------------
# Kubernetes Cluster - RBACs on ACR
#-----------------------------------------------------------------------------------------------
...
variable "virtual_network_name" {
  type        = string
  default     = ""
  description = "Name of the virtual network where AKS will be deployed"
}

variable "network_resource_group_name" {
  type        = string
  default     = ""
  description = "Name of the resource group where virtual network has been deployed"
}
...
variable "custom_kubernetes_recording_rules_rule_group_enabled" {
  type        = bool
  default     = false
  description = "Indicates whether the custom kubernetes recording rules rule group should be enabled."

}

variable "custom_kubernetes_recording_rules_rule_group" {
  type = list(object({
    record     = string
    expression = string
  }))
  description = "(Optional) The custom kubernetes recording rules rule group. Defaults to \"\"."
  default     = []
