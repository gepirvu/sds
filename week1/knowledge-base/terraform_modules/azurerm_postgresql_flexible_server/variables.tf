...
# Random password generation for the PostgreSQL server administator login
...
variable "username_secret_name" {
  type        = string
  default     = "pgsqlflexible-server-admin"
  description = "The name of the secret in KeyVault to store the PostgreSQL server administrator login name"
}

variable "password_secret_name" {
  type        = string
  default     = "pgsqlflexible-server-admin-password"
  description = "The name of the secret in KeyVault to store the PostgreSQL server administrator password"
}

variable "administrator_login_name" {
  type        = string
  default     = "pgsqlflexiadmin"
  description = "The name of the PostgreSQL server administrator login"
}
