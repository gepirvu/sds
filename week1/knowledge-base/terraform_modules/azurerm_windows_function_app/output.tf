...
output "function_app_ids" {
  value = {
    for usecase, app in azurerm_windows_function_app.function_app : usecase => app.id
  }
}
...
output "function_app_names" {
  value = {
    for usecase, app in azurerm_windows_function_app.function_app : usecase => app.name
  }
}
...
output "function_app_default_hostnames" {
  value = {
    for usecase, app in azurerm_windows_function_app.function_app : usecase => app.default_hostname
  }
}