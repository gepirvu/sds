...
## Identity variables
variable "identity" {
  description = "Map with identity block informations as described here https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/windows_virtual_machine#identity."
  type = object({
    type         = string
...
variable "hotpatching_enabled" {
  description = "Should the VM be patched without requiring a reboot? Possible values are true or false. Defaults to false. For more information about hot patching please see the product documentation."
  type        = bool
  default     = false
}

variable "patch_mode" {
  description = "Specifies the mode of in-guest patching to this Windows Virtual Machine. Possible values are Manual, AutomaticByOS and AutomaticByPlatform. Defaults to AutomaticByOS. For more information on patch modes please see the product documentation."
  type        = string
...
#-------------------------------------------------------------------------------------------------------------------------------
#_________________________ enable_antimalware_extension _______________________________________                                     
#-------------------------------------------------------------------------------------------------------------------------------

variable "enable_antimalware_extension" {
  type        = bool
  description = "set true if Vm requires anti-malware extension configuration, otherwise false"
  default     = false
}

variable "antimalware_configuration" {
  type = object({
    name                                = string
    type_handler_version                = string
    iaas_antimalware_enabled            = bool
    iaas_antimalware_exclusions         = string
    iaas_antimalware_protection_enabled = bool
    iaas_antimalware_scan_settings      = string
  })
  description = "animalware extension configuartion"
  default     = null
}
